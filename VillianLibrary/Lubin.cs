...
{
    public class Lubin : Villian
    {

        public Weapons EquippedWeapon { get; set; }

        public Lubin(string name, int life, int maxLife, int hitBonus, int block, int minDamage, int maxDamage, string description, Weapons equippedWeapon)
