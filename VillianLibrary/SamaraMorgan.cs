...
{
    public class SamaraMorgan : Villian
    {

        public Weapons EquippedWeapon { get; set; }

        public SamaraMorgan(string name, int life, int maxLife, int hitBonus, int block, int minDamage, int maxDamage, string description, Weapons equippedWeapon)
